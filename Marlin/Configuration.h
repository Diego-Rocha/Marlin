...
#define STRING_CONFIG_H_AUTHOR "Diego Rocha" // Who made the changes.
...
#if ENABLED(SAPPHIRE_MOD)
  #define CUSTOM_MACHINE_NAME "Sapphire"
#elif ENABLED(BLUER_MOD)
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #elif ENABLED(SAPPHIRE_MOD)
    #define DEFAULT_Kp 21.3
    #define DEFAULT_Ki 1.95
    #define DEFAULT_Kd 62.7
  #elif ENABLED(BLUER_MOD)
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #if ENABLED(SAPPHIRE_MOD)
    #define DEFAULT_bedKp 65.5
    #define DEFAULT_bedKi 9.50
    #define DEFAULT_bedKd 301.2
  #elif ENABLED(BLUER_MOD)
    #define DEFAULT_bedKp 22.07
    #define DEFAULT_bedKi 3.88
    #define DEFAULT_bedKd 83.74
  #endif
...
#define DEFAULT_MAX_ACCELERATION      { 7000, 7000, 300, 10000 }
 ...
 */
#if ENABLED(SAPPHIRE_MOD)
  #define NOZZLE_TO_PROBE_OFFSET { 0, -42.8, -0.1 }
#elif ENABLED(BLUER_MOD)
  #define NOZZLE_TO_PROBE_OFFSET { 0, -42.8, -0.5 }
#endif
...
#define TOUCH_SCREEN
  ...
  #define TOUCH_CALIBRATION_Y -11535
